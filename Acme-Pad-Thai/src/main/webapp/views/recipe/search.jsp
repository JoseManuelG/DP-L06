...
<form:form action="recipe/search.do" modelAttribute="stringForm" >

	
	<form:label path="text">
		<spring:message code="recipe.search.search" />:
	</form:label>
	...
	<jstl:if test="${not empty recipes}">
		<display:table pagesize="5" class="displaytag" keepStatus="false"
		name="recipes" requestURI="recipe/search" id="row">
