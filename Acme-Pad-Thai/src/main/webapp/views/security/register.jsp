...
<form:form action="${requestURI}" modelAttribute="actorForm">
	...
	<form:label path="typeOfActor">
		<spring:message code="security.typeOfActor" />
	</form:label>
	...
	<form:label path="companyName">
				<spring:message code="security.companyName" />
			</form:label>
	<spring:message code="security.companyName.inside" var="aux" />
	<form:input path="companyName" value="${aux}"/>	
