...
<form:form action="cook/search.do" modelAttribute="stringForm" >

	
	<form:label path="text">
		<spring:message code="cook.search.search" />:
	</form:label>
	...
	<input type="submit" name="Accept" value="<spring:message code="cook.search.accept" />" />
	...
	<jstl:if test="${not empty cooks}">
		...
		<display:column title="${viewTitleHeader}">
				<spring:message code="cook.title" />
		</display:column>
		</display:table>
	</jstl:if>
